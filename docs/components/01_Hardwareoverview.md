...
The individual motor installations are documented in more detail in the dedicated [Motors documentation](03_Motors.md).
...
<sub><b>Figure 1.4.</b> Top view of Piolín's front Ackermann-style steering mechanism.</sub>
...
<sub><b>Figure 1.5.</b> Left and right ultrasonic sensors installed laterally on Piolín.</sub>
...
The Color Sensor and its physical isolation casing are documented in detail in [Color Sensor](06_ColorSensor.md).

---

## 1.7 Open Challenge Configuration: Gyro-Assisted Navigation
...
<sub><b>Figure 1.6.</b> EV3 Gyro Sensor installed in the Open Challenge configuration.</sub>
...
## 1.8 Why the Gyro Was Reintroduced
...
## 1.9 Obstacle Challenge Configuration: Pixy2.1
...
<sub><b>Figure 1.7.</b> Piolín configured for the Obstacle Challenge with Pixy2.1 replacing the Gyro Sensor on S1.</sub>
...
The detailed vision architecture and target-selection logic are documented in [Pixy2.1 Vision](07_PixyVision.md).

---

## 1.11 Pixy2.1 and the Two Ultrasonic Sensors
...
## 1.12 Permanent vs. Round-Specific Hardware
...
## 1.14 Complete Open Challenge Hardware Map
...
## 1.15 Complete Obstacle Challenge Hardware Map
...
Detailed reconstruction diagrams are kept in the EV3 and power-distribution documentation rather than duplicated here.

---

## 1.16 Hardware Evolution and Engineering Decisions
...
## 1.17 Current Architecture Compared with Previous Designs
...
## 1.18 Why the Final Architecture Was Selected
...
## 1.20 Current Hardware Evidence
...
<sub><b>Figure 1.8.</b> Top view of the Open configuration showing the permanent vehicle platform and Gyro Sensor configuration.</sub>
...
<sub><b>Figure 1.9.</b> Top view of the Obstacle configuration showing Pixy2.1 replacing the gyro while the remainder of the platform remains unchanged.</sub>
...
## 1.21 Hardware Documentation Structure
...
[Pixy2.1 Vision Sensor](07_PixyVision.md) documents the current Obstacle Challenge camera, its signatures, block information, direct EV3 integration, and the reasons it replaced the HuskyLens/Nano architecture.
...
## 1.22 Final Hardware Design Principle
